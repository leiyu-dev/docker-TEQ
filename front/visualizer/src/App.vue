<template>
  ...
  >
    ...
    <div style="display: flex; align-items: center;">
      ...
      <span style="font-size: 23px; font-weight: bold; margin-left: 20px;">Dashboard</span>
    </div>
      ...
      >
        ...
        <el-sub-menu index="1">
          ...
          <router-link to="/config/global" style="text-decoration: none; color: inherit;">
            <el-menu-item index="/config/global" class="menu-item"> Global Config </el-menu-item>
          </router-link>
          <router-link to="/config/node" style="text-decoration: none; color: inherit;">
            <el-menu-item index="/config/node" class="menu-item"> Node Config </el-menu-item>
          </router-link>
        </el-sub-menu>
